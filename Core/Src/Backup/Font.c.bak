...
static unsigned char Bit_Is_Set(unsigned char ,unsigned char);
...
unsigned int 						FgColor 				= Color_BLACK;			// Text fg color, 5-6-5 RGB
unsigned int 						BkColor 				= Color_WHITE;			// Text bk color, 5-6-5 RGB
...
{
			 TFTWidth=TFT_HEIGHT-1;
			 TFTHeight=TFT_WIDTH-1;
			 cursorX = TFTWidth;
}
		 else if(p_rotation ==0 || p_rotation ==2)
{
			 TFTWidth=TFT_WIDTH-1;
			 TFTHeight=TFT_HEIGHT-1;
			 cursorX = TFTWidth;
};
