...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOF, LCD_LED_Pin|LCD_CS_Pin|Touch_DIN__MOSI_Pin|Touch_CS_Pin
  ...
  /*Configure GPIO pins : PFPin PFPin PFPin PFPin
                           PFPin */
  GPIO_InitStruct.Pin = LCD_LED_Pin|LCD_CS_Pin|Touch_DIN__MOSI_Pin|Touch_CS_Pin
                          |LCD_RST_Pin;
  ...
  /*Configure GPIO pin : PtPin */
  GPIO_InitStruct.Pin = Touch_Out__MISO_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(Touch_Out__MISO_GPIO_Port, &GPIO_InitStruct);
